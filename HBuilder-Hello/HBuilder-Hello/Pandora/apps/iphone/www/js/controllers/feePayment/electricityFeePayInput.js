define(function(require, exports, module) {
	...
	mui.plusReady(function() {
		...
		electricityBalance = self.balance;
		...
		document.getElementById("nextBtn").addEventListener("tap",function(){
			...
			function getOrderFlowNo(){
				...
				mbank.apiSend("post",urlVar,"",getOrderFlowNoSucFunc,getOrderFlowNoFailFunc,false);
				function getOrderFlowNoSucFunc(data2){
					if(data2.ec =="000"){
						...
						mbank.openWindowByLoad('../feePayment/electricityFeePayConfirm.html','electricityFeePayConfirm','slide-in-right',params);
					}else{
