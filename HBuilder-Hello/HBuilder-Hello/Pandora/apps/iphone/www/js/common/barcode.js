...
w.clicked=function(id,wa,ns){
	...
	if(w.plus){
		...
		var pre='';
		openw=plus.webview.create(pre+id,barcodeId,{scrollIndicator:'none',scalable:false});
...
//	plus.nativeUI.confirm('本OS原生层面不提供该控件，需使用mui框架实现类似效果。请点击“确定”下载Hello mui示例',function(e){
	mui.confirm('本OS原生层面不提供该控件，需使用mui框架实现类似效果。请点击“确定”下载Hello mui示例', "提示", ["确定", "取消"], function(e) {
		if(0==e.index){
