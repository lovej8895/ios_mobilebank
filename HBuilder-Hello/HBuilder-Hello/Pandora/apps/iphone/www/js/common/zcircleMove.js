...
// create by zcy 2016/10/10
	...
	function runCircle(settings){
		 var defaultSetting={ 
            ...
            outerColorStart:'#009def',  //外部圆环 渐变色
			outerColorMid:'#009def',
			outerColorEnd:'#000000',
		...
		R0=parseInt(canvasW/2-lineW0-39);
		R1=parseInt(canvasW/2-lineW1-lineW0-10);
		var ra=parseInt(canvasW/2-lineW0/2-40);
		var canvasH=canvasW;
...
//				context.fillRect(0,0,canvasC.width,canvasC.height);
				...
				context.arc(0,0,R0,0,(Math.PI*2)*loading/100,false);
				context.stroke();
				context.closePath();
				//中环
				/*context.beginPath();
				...
				context.arc(0,0,R1,0,(Math.PI*2)*loading/100,false);
				context.stroke();
				context.closePath();
				context.beginPath();
				// Linear gradients
                ...
                //文字  进度
				 ...
				 context.fillText(parseInt(parseFloat(loading))+"%",-18,6);
				 context.closePath();
				
				//画图
				startAa += (Math.PI*2)*loading/100;
				context.save();
				context.setTransform(1,0,0,1,0,0);
			...
			drawScreen();
//			Timer=setInterval(drawScreen,300)
