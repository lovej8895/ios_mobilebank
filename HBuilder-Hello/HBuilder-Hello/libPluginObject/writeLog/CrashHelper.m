...
#define CRASHLOG ([[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0] stringByAppendingPathComponent:@"CrashLog"])
...
//    return iswriten;
    ...
    [defaults setObject:content forKey:@"BENGKUIRIZHI"];
